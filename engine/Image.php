...
class Image {
    ...
    public function __construct($filename = null) {
        if (extension_loaded('gd')) {
            ...
            echo "<h2>Framework requires the GD extension for PHP to be loaded for image uploaders to work</h2>";
            echo "<p>This is not a problem with Framework but a setup issue with your PHP instance.</p>";
