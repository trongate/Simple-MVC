...
?>
    ...
    <script type="text/javascript">
        ...
        function drawShowSQLPage(sql, file, warning) {
            ...
            if (warning == true) {
                alert("Framework detected some potentially dangerous code embedded within this SQL file.  Be extra careful!");
            }
        ...
        function explainTooBig(target_file, filePath) {
            ...
            <?php
            $page_content = '<p>For automatic database setup, Framework has filesize limit of 1MB (1,000kb).</p>';
